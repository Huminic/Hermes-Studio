    ...
    <div className="flex h-full flex-col overflow-y-auto" style={{ background: 'var(--theme-bg)' }}>
      <div className="mx-auto w-full max-w-5xl px-6 py-10">
        ...
        <section id="overview" style={sectionStyle}>
          ...
          <h3 style={h3Style}>What is Huminic Studio</h3>
          <p style={pStyle}>
        ...
        <section id="api-reference" style={sectionStyle}>
          ...
          <p style={pStyle}>
            All API endpoints are served by the Huminic Studio server process and proxy to the Hermes Gateway where appropriate. Base path: <code style={codeStyle}>/api</code>. All mutating endpoints require <code style={codeStyle}>Content-Type: application/json</code>. Authentication is via session cookie or Bearer token.
          </p>
...
jobs:
  ...
  "supervised": false            // Require approvals for workers
          ...
          <p style={pStyle}>
            Several data stores use the <code style={codeStyle}>.runtime/</code> directory within the Huminic Studio installation:
          </p>
          <dl style={dlStyle}>
          ...
          <table style={tableStyle}>
            ...
            <tbody>
              ...
              <tr><td style={tdCodeStyle}>HERMES_PASSWORD</td><td style={tdStyle}>(none)</td><td style={tdStyle}>Password required to log into Huminic Studio. When set, the login screen is shown on first visit.</td></tr>
              ...
              <tr><td style={tdCodeStyle}>PORT</td><td style={tdCodeStyle}>3000</td><td style={tdStyle}>Port number for the Huminic Studio server.</td></tr>
            </tbody>
          </table>
        </section>
        ...
        <section id="design-system" style={sectionStyle}>
          ...
          <p style={pStyle}>
            Huminic Studio uses a CSS custom property theming system with 5 available themes. Themes are applied by setting the <code style={codeStyle}>data-theme</code> attribute on the document root. All themes operate in dark mode only.
          </p>
          <table style={tableStyle}>
            <thead>
            ...
            <tbody>
              <tr><td style={tdCodeStyle}>hermes-os</td><td style={tdStyle}>Huminic OS</td><td style={tdStyle}>Electric blue cinematic agent OS theme. The default theme.</td></tr>
              <tr><td style={tdCodeStyle}>hermes-official</td><td style={tdStyle}>Huminic Official</td><td style={tdStyle}>Navy and indigo flagship theme with professional aesthetics.</td></tr>
              <tr><td style={tdCodeStyle}>hermes-classic</td><td style={tdStyle}>Huminic Classic</td><td style={tdStyle}>Bronze accents on dark charcoal for a warm, sophisticated look.</td></tr>
          ...
          <p style={pStyle}>
            Huminic Studio uses <strong>HugeIcons</strong> (<code style={codeStyle}>@hugeicons/react</code> with <code style={codeStyle}>@hugeicons/core-free-icons</code>) as its primary icon library. Icons are imported individually by name and rendered via the <code style={codeStyle}>HugeiconsIcon</code> component. The icon set provides consistent 24px stroke icons with adjustable size and color props.
          </p>
        ...
        <div style={{ textAlign: 'center', padding: '2rem 0', color: 'var(--theme-muted)', fontSize: '0.85rem' }}>
          <p>Huminic Studio Documentation v1.20.0</p>
