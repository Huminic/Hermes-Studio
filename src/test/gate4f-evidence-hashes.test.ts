...
// Durable guard: recompute every SHA-256 recorded in the Gate 4F proof delta from the current
...
const PROOF = new URL(
  '../../docs/halo/evidence/m1r/residual/PROOF_DELTA_F_scheduled_residual_audit.md',
  import.meta.url,
)
...
describe('Gate 4F evidence hashes', () => {
  const recorded = parseRecordedHashes()

  it('records six artifact/source hashes', () => {
