...
// Durable guard: recompute every SHA-256 recorded in the Gate 5A proof delta from the current
...
const PROOF = new URL(
  '../../docs/halo/evidence/m1r/gate5a/PROOF_DELTA_K_baseline_rank_audit.md',
  import.meta.url,
)
...
describe('Gate 5A evidence hashes', () => {
  const recorded = parseRecordedHashes()

  it('records eight artifact/source hashes', () => {
