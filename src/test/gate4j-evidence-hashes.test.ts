...
// Durable guard: recompute every SHA-256 recorded in the Gate 4J proof delta from the current
...
const PROOF = new URL(
  '../../docs/halo/evidence/m1r/residual/PROOF_DELTA_J_crm_report_reconciliation.md',
  import.meta.url,
)
...
describe('Gate 4J evidence hashes', () => {
