...
// Durable guard: recompute every SHA-256 recorded in the Gate 4G proof delta from the current
...
const PROOF = new URL(
  '../../docs/halo/evidence/m1r/residual/PROOF_DELTA_G_final_residual_audit.md',
  import.meta.url,
)
...
describe('Gate 4G evidence hashes', () => {
