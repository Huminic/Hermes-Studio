...
// Durable guard: recompute every SHA-256 recorded in the Gate 4I proof delta from the current
...
const PROOF = new URL(
  '../../docs/halo/evidence/m1r/residual/PROOF_DELTA_I_response_times_measured_unscored.md',
  import.meta.url,
)
...
describe('Gate 4I evidence hashes', () => {
  const recorded = parseRecordedHashes()

  it('records five artifact/source hashes', () => {
