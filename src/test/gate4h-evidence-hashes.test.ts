...
// Durable guard: recompute every SHA-256 recorded in the Gate 4H proof delta from the current
...
const PROOF = new URL(
  '../../docs/halo/evidence/m1r/residual/PROOF_DELTA_H_downstream_contract.md',
  import.meta.url,
)
...
describe('Gate 4H evidence hashes', () => {
