...
| P-23 | C | Widget public route | `/w/$slug` unauth renders | **chat** mode live; **form/voice/video = honest "coming soon" stub** (by design, AC.4.4 deferred). Form *ingestion* via /api/public/widget-form works live (thread 8a8bf357, notified:true). | curl + Dexter | 🟡 PARTIAL — chat live; form UI deferred (decision D-07) |
