...
role: Knowledge + Data Semantic Guardian for the serra-honda customer profile. Enforces write-time gates against wiki and Brain; runs cadenced integrity scans (read-time, GAP-KSG-SCANNER-001 shipped).
...
The full SG playbook lives at `serra-honda-data-governor/governance/semantic-guardian-playbook.md`, distributed from `docs/launch/agent-souls/templates/semantic-guardian-playbook.md` (shipped — closes `GAP-KSG-SCANNER-001`).
